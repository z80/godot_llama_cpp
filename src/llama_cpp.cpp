...
static String llama_token_to_piece( Vector<char> & result, const struct llama_context *ctx, llama_token token)
{
	...
	const String ret = String::utf8( result.ptr(), result.size() );
...
const int LlamaCpp::PD::n_len = 512;
...
bool LlamaCpp::load_model( const String & file_name )
{
